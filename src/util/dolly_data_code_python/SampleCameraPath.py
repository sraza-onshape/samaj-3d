...
def SampleCameraPath():
    ...
    scale_factor_focal_length_y = 1.125
    scale_factor_focal_length_x = 1.125
    K[1, 1] *= scale_factor_focal_length_y
    K[0, 0] *= scale_factor_focal_length_x
    ...
    def compute_rotation_matrix(camera_position, object_position):
        ...
        # Compute rotation angles to align direction vector with negative Z-axis
        # First, compute yaw angle (rotation about Y-axis)
    ...
    # camera_x, camera_y, camera_z = 1.25, 0.30, -3.45
    camera_x, camera_y, camera_z = 0.12, 0.30, -2.32
    camera_position = move = np.array([camera_x, camera_y, camera_z])

    # Object position in world space
    object_x, object_y, object_z = 0.12, 0.30, -3.265
    object_center = np.array([object_x, object_y, object_z])

    R = compute_rotation_matrix(camera_position, object_center)
